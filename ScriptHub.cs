...
namespace Executor
{
    public partial class ScriptHub : FadeForm
    {
        ...
        private void attachButtonFix_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Inject fix failed! Try using the normal inject. If that doesn't work report the bug at https://github.com/Plextora/Executor/issues");
            }
        }
